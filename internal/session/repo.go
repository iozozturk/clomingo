...
func NewSessionRepo(db *db.Datastore, logger *zap.Logger) *Repo {
	return &Repo{ds: db.DS, logger: logger}
}

func (r *Repo) save(ctx context.Context, sess *Session) (*Session, error) {
...
func (r *Repo) findKeysByDeviceId(ctx context.Context, deviceId string) ([]int64, error) {
...
func (r *Repo) deleteMany(ctx context.Context, ids []int64) error {
	keys := idsToKeys(ids)
...
func (r *Repo) deleteById(ctx context.Context, id int64) {
...
func (r Repo) GetBySessionToken(ctx context.Context, sessionToken string) (*Session, error) {
